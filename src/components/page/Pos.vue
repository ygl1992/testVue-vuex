        ...
        <el-col :span='7' class="pos-order" id="order-list">
          <el-tabs>
            <el-tab-pane label="点餐">
              ...
              <div class="tongji"><small>数量：</small>{{totalCount}}，<small>总价：</small>￥{{totalMoney}}</div>
              <div class="div-btn">
...
export default {
  ...
  mounted () {
    var orderHeight = document.querySelector('body').clientHeight
  ...
  methods: {
    ...
    checkout () {
      if (this.totalCount !== 0) {
        ...
        this.totalMoney = 0
        this.$message({
          message: '结账成功，感谢你为店里出的一份力',
          type: 'success'
        })
      } else {
        this.$message.error('不能空结，老板知道你用心工作')
      }
    }
  }
}
